...
class LeadFOScreen extends StatefulWidget {
  const LeadFOScreen({Key? key}) : super(key: key);

  @override
  State<LeadFOScreen> createState() => _LeadFOScreenState();
}

class _LeadFOScreenState extends State<LeadFOScreen> with SingleTickerProviderStateMixin {
